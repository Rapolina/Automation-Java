...
import com.company.DAY4.TestEngineer;
...
public class ExecuteTestTest {
    ...
    private int skill;
    private com.company.DAY4.entity.Test test;
    private  Result expected;

    public ExecuteTestTest(Engineer engineer, int skill, com.company.DAY4.entity.Test test, Result expected) {
